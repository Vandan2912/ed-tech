...
function LeaveRoomPanel({ onConfirm }: { onConfirm: () => void }) {
  return (
    <div className="bg-red-50 border border-red-100 rounded-2xl p-6 flex flex-col items-center text-center gap-3">
      ...
      <div>
        <p className="text-[14px] font-black text-red-600 uppercase tracking-wider">Leave Room</p>
        <p className="text-[12px] text-red-400 font-medium mt-0.5">Your progress is saved</p>
      </div>
      <button
        onClick={onConfirm}
...
export default function StudyRoom() {
  ...
  return (
    <main className="min-h-screen bg-[#F9FAFB]">
      <InviteLearnersModal isOpen={inviteOpen} onClose={() => setInviteOpen(false)} />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 space-y-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-5">
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-br from-[#1C398E] via-[#2250C4] to-[#3B5FD4] rounded-3xl px-8 py-8 text-white overflow-hidden"
          >
            {/* Decorative blobs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[12px] font-black uppercase tracking-widest text-gray-500">In Room</span>
              </div>
            ...
            <div className="space-y-2">
              {MEMBERS.map((m) => (
                <div key={m.id} className="flex items-center gap-3 px-3 py-2.5 bg-gray-50 rounded-xl">
                  ...
                  <span className="flex-1 text-[13px] font-bold text-[#101828]">{m.name}</span>
                  {m.role === "host" ? (
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[12px] font-black uppercase tracking-widest text-emerald-700">Session Goals</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {GOALS.map((goal, i) => (
                <div key={i} className="flex items-start gap-3 bg-white/70 border border-emerald-100 rounded-xl px-4 py-3">
                  ...
                  <span className="text-[13px] font-semibold text-emerald-900 leading-snug">{goal}</span>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-[12px] font-black uppercase tracking-widest text-gray-700">Shared AI Insights</p>
                <p className="text-[11px] text-gray-400 font-medium">AI chats from everyone · visible to all members</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
            {AI_INSIGHTS.map((insight) => (
              <div key={insight.id} className="border border-gray-100 rounded-2xl p-4 hover:border-gray-200 transition-colors">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      <span className="text-[12px] font-bold text-[#101828]">{insight.author}</span>
                      {insight.isYou && (
                    ...
                    <span className="text-[11px] text-gray-400 font-medium">{insight.timeAgo}</span>
                  </div>
                ...
                <button className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-wider text-gray-400 hover:text-blue-600 transition-colors focus-visible:outline-none">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-black text-[#1C398E] uppercase tracking-wider">Invite Learners</p>
